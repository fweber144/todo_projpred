...
* As soon as a version of package **Matrix** > 1.6-4 is out: Search the **projpred** code for `packageVersion("Matrix") >= "1.6-4"` and see if it is possible to replace those occurrences by `packageVersion("Matrix") == "1.6-4"`.
